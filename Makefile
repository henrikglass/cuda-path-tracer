...
NVCC 		= nvcc
NVCC_FLAGS 	= -ccbin clang++-8 -use_fast_math -Xcompiler -O2 -dc -arch=sm_75 #-gencode arch=compute_75,code=sm_75 -lineinfo #-G#-arch compute_75 #-G -lineinfo -Xcompiler -Wall -Xcompiler -Wextra -Xcompiler -p -Xcompiler -pg
NVCC_LIBS 	= -Iexternal
